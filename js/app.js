...
function listPropertiesFromDB(pagetype)
{
    ...
    propertylistings.getAll(function (data) {
        ...
        for (var i = 0; i < data.length; ++i) {
            ...
            //var href = '"properties.html?id=' + property.propertyid + '"' + ' data-prefetch="true"';
...
function registerEvents()
{
    ...
    $(document).on("vclick", ".show-page-loading-msg", function ()
    {
        var $this = $(this),
    ...
    }).on("vclick", ".hide-page-loading-msg", function ()
    {
        $.mobile.loading('hide');
    });
}