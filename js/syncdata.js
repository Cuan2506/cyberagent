...
$("#syncPropertySubmit").on("touchstart", function (e) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            propertylistings.applyChanges({ id: propertylistingdata.id, propertyid: propertylistingdata.propertyid, summary: propertylistingdata.summary, jsonform: propertylistingdata.jsonform, imagecount: propertylistingdata.imagecount, formvars: propertylistingdata.formvars, status: "Submitted", lastmod: propertylistingdata.lastmod, submitteddate: new Date().getTime(), imagesuploadeddate: new Date().getTime() },
               function () {
